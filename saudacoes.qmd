...
|       Olá ! Seja muito bem-vindo a este *Curso de Capacitação* com ferramentas digitais para o *Ensino Médio*. A ideia central *desta etapa* do *Curso* é lhe oferecer ferramentas que possibilitem agregar valor à imagens de moléculas, gráficos e mapas observados durante o ensino médio, mas com *animação e interatividade*.
