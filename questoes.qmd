...
## De que se trata essa capacitação ? 

|       Bom, como diz o título, de *vivificar* imagens e relações numéricas encontrados em livros-texto. Em palavras mais abstratas...da tentativa de se oferecer algumas ferramentas para compor objetos didáticos para o *Ensino Médio*, principalmente para *Ciências da Natureza e Suas Tecnologias*, também com *aplicações da Matemática* e baseadas em premissas de *Ensino Reprodutível*. 
...
## Como os alunos podem beneficiar-se da oferta das ferramentas que serão tratadas no Curso ?
...
|       Assim, o Curso pretende oferecer uma ferramenta para auxiliar na abstração *de cartoon*, e outra para o *simbólico*, *esquemático*, *gráfico*, e de análise de dados presente na abstração *realística*. Essa segunda ferramenta permitirá acessar o conteúdo de livros-texto por animações e simulações.
...
## Se o Curso envolve o uso de livros-texto, qual bibliografia será utilizada ?

|       Nenhuma. Na verdade será utilizado algum conteúdo geral presente no [Material de Apoio Pedagógico para Aprendizagens - MAPA](https://seliga.educacao.mg.gov.br/cardenos-mapa/ensino-m%C3%A9dio-2024) para habilidades previstas no *Currículo Referência de Minas Gerais*, e pertinente principalmente à *Ciências da Natureza e Suas Tecnologias*.

## Além dos conteúdos específicos com algum potencial para melhorar o aprendizado do estudante, há outra vantagem no aprendizado dos programas ?
