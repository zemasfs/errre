...
1. Acesse o site do [Rstudio](https://posit.co/download/rstudio-desktop/) e faça o *download* do programa `R`.
![](rstudioSite.png)
1. Instale o programa com as opções padrão.

2. No mesmo site do ´[RStudio](https://posit.co/download/rstudio-desktop/) procure um pouco mais abaixo pelo instalador mais apropriado a seu sistema operacional.
...
5. A imagem final será bem parecida com a apresentada pela versão instalada, como visto na @fig-rstudioJanela, veja:
...
|       Por uma questão de simplicidade para o uso da versão em servidor, sem necessidade de instalação dos programas, bem como por maior velocidade de execução de *scripts* e instalação de pacotes, optamos neste trabalho por exemplificar os *objetos didáticos* em nuvem, ou seja, por uso do [RStudio Cloud](https://posit.cloud/).
